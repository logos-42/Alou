...
var logger = (0, import_debug.default)("agent-toolkit:payloadUtils");
...
var logger2 = (0, import_debug2.default)("agent-toolkit:functions");
...
async function updateSubscription(client, context, params) {
  ...
  try {
    ...
    const response = await import_axios.default.patch(apiUrl, operations, { headers });
    return response.data;
  } catch (error) {
...
var logger3 = (0, import_debug3.default)("agent-toolkit:client");
...
var fixedPriceSchema = import_zod.z.object({
...
var autoBillOutstandingSchema = import_zod.z.boolean().optional().describe("Indicates whether to automatically bill outstanding amounts.");
var paymentFailureThresholdSchema = import_zod.z.number().optional().describe("The number of failed payments before the subscription is canceled.");
...
var taxPercentageSchema = import_zod.z.string().optional().describe("The tax percentage.");
var taxInclusiveSchema = import_zod.z.boolean().optional().describe("Indicates whether the tax is inclusive.");
...
var showSubscriptionDetailsParameters = (context) => import_zod.z.object({
  ...
  get_additional_details: import_zod.z.boolean().optional().describe("Get all detailed information for the subscription.")
});
...
var updateSubscriptionParameters = (context) => import_zod.z.object({
  ["subscription_id" /* subscriptionId */]: import_zod.z.string().describe("The ID of the subscription to update."),
  ["currency_code" /* currencyCode */]: import_zod.z.enum(["USD"]).optional().default("USD").describe("Currency code of the amount."),
  ["outstanding_balance" /* outstandingBalance */]: import_zod.z.string().optional().describe("Outstanding Balance in the subscription"),
  ["custom_id" /* customId */]: import_zod.z.string().optional().describe("The custom id for the subscription"),
  ["fixed_price" /* fixedPrice */]: import_zod.z.object({
    value: import_zod.z.string().describe("The fixed price for the subscription."),
    sequence: import_zod.z.number().describe("The order sequence for the billing cycles")
  ...
  ["shipping_amount" /* shippingAmount */]: import_zod.z.string().optional().describe("The value of the shipping amount."),
  ["shipping_address" /* shippingAddress */]: ShippingAddressSchema.optional().describe("The shipping address.")
});
var getRefundParameters = (context) => import_zod.z.object({
  refund_id: import_zod.z.string().describe("The ID of the refund to get details for.")
});
var createRefundParameters = (context) => import_zod.z.object({
  capture_id: import_zod.z.string().describe("The ID of the capture to refund."),
  amount: import_zod.z.object({
    currency_code: import_zod.z.string(),
    value: import_zod.z.string()
  }).optional().describe("The amount to refund. If not specified, the full captured amount is refunded."),
  invoice_id: import_zod.z.string().optional().describe("The invoice ID that is used to track this payment."),
  note_to_payer: import_zod.z.string().optional().describe("A note to the payer.")
});
